...
echo ""
echo "  1. Open Outlook"
echo "  2. Click  Get Add-ins  (ribbon or ••• menu)"
echo "  3. Go to  My Add-ins  →  Add a custom add-in  →  Add from URL"
echo "  4. Paste this URL:"
echo ""
echo "     https://raw.githubusercontent.com/${REPO}/main/manifest.prod.xml"
echo ""
echo "  5. Click Install — the 'Create SE Assist' button will appear"
